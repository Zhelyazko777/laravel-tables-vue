<template>
  <div :class="visibilityClass" class="slider-menu">
    <div class="slide-menu-header-container">
      <div class="bold menu-title">
        {{title}}
      </div>
      <div @click="onCloseIconClick">
...
export default {
  ...
  computed: {
    visibilityClass () {
      return this.isShown ? 'menu-shown' : '';
    },
  },
  methods: {
    open () {
...
<style lang="scss" scoped>
  ...
  .slider-menu {
    box-shadow: -2px 0px 10px 0px #36303091;
    position: fixed;
    height: 100%;
    ...
    right: calc(0% - #{$sliderMenuWidth} - 5%);
